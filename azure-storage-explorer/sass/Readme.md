...
folder are mapped to the application's root namespace, 'AzureStorageExplorer'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'AzureStorageExplorer' in the same way
as `"AzureStorageExplorer/sass/src"`.
